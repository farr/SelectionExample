...
We thank Maggie Lieu for pointing out the counterexample given in the
final footnote of this document.  An example of a worked population analysis
using this method can be found at
\url{https://github.com/farr/SelectionExample}.  IM's work was performed in part at Aspen Center for Physics, which is supported by National Science Foundation grant PHY-1607611; IM's visit there was partially supported by a grant from the Simons Foundation.
